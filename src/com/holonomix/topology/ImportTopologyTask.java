...
public class ImportTopologyTask {

	private static final Logger log = Logger
			.getLogger(ImportTopologyTask.class);
	private PropertiesContainer propertiesContainer;

	public ImportTopologyTask() {
	...
	public void doImport() {
		...
		try {
			...
			topologyAdapterInterface.getDevicesAndVlans(mapDevice, mapVLans,
					listSeedFile);
			//if ZTE or MET import networkConnection
			if (com.holonomix.ClassFactory.getEnum() == EnumAdapterName.HWMETE
					|| ClassFactory.getEnum() == EnumAdapterName.HWZTE)
				// davide
				//if(1==2)
				topologyAdapterInterface
						.getNetworkConnection(listNetworkConnection);
